...
/*** The functions below prent numbers ***/
...
/*** the functions below print memory address ***/
int print_pointer(va_list types, char buffer[], int flags,
		int width, int precision, int size);

/*** the below function handles other specifiers ***/
...
/*** the below function prints a sring in rot13 ***/
int print_rot13string(va_list types, char buffer[], int flags,
		int width, int precision, int size);

/*** the below functions handles width ***/
...
int write_unsgnd(int is_negative, int ind, char[], int flags,
		int width, int precision, int size);
